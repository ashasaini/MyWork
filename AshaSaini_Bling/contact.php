			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="cart.php">Shopping Cart</a> <!-- pending -->
						</li>
						<li>
		...
		<div class="col-md-9">
			...
			<div class="row">
				<label>
					<h4> CONTACT US</h4>
					By Phone 
					Our Customer Service Team is available to take your calls daily during the following business hours </br>(Pacific Standard Time): 
					Sunday and Saturday: 8:00am - 5:00pm 
					Monday thru Friday: 5:00am - 6:00pm 
					</br></br>
					U.S. and Canadian Shoppers (Toll Free): 
					1-23-456-789
					</br></br>
					...
					Email Us 
					Do not have enough time to call? Our Customer Service Team will review and respond to your email as quickly as possible.
				</label>
			</div>
		</div>
		<!-- /.container -->
