    ...
    switch(m_Child_uid) {
        case IDC_WINDOW_CONTROL1:
            ...
            if(m_ImgBuf1) {
                ...
                CEPILogHelper::WriteToErrorLog(_T("Memory allocation for m_ImgBuf1 failed "), __LINE__, __FILE__);
        ...
        case IDC_WINDOW_CONTROL3:
            ...
            if(m_ulColoredImg3) {
                ...
                CEPILogHelper::WriteToErrorLog(_T("Memory allocation failed."), __LINE__, __FILE__);
                return EPI_MEM_ALLOC;
            }
