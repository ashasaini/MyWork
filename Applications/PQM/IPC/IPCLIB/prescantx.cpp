 ...
 *
 *  File Name: prescantx.cpp
 *  Overview: Implementation of CPreScanTx class.
...
//*****************************************************************************
CPreScanTx::CPreScanTx(
    CScanProcedure* scan_proc
): CPreScan(
        scan_proc
    )
{
    LPCTSTR FUNC_NAME = _T("CPreScanTx::CPreScanTx");
    PQM_TRACE1(SYSTEM_FUNC_MARKER, FUNC_NAME, _T("Trace of CPreScanTx::CPreScanTx"));
