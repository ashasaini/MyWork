 ...
 *
 *  File Name: prescanmodeall.cpp
 *  Overview: Implementation of CPreScanModeAll class.
...
//*****************************************************************************
CPreScanModeAll::CPreScanModeAll(
    CScanProcedure* scan_proc
): CPreScan(
        scan_proc
    )
{
    LPCTSTR FUNC_NAME = _T("CPreScanModeAll::CPreScanModeAll");
    PQM_TRACE1(SYSTEM_FUNC_MARKER, FUNC_NAME, _T("Trace of CPreScanModeAll::CPreScanModeAll"));
