 ...
 *
 *  File Name: prescancoil.cpp
 *  Overview: Implementation of CPreScanCoil class.
...
//*****************************************************************************
CPreScanCoil::CPreScanCoil(
    CScanProcedure* scan_proc
): CPreScan(
        scan_proc
    )
{
    LPCTSTR FUNC_NAME = _T("CPreScanCoil::CPreScanCoil");
    PQM_TRACE1(SYSTEM_FUNC_MARKER, FUNC_NAME, _T("Trace of CPreScanCoil::CPreScanCoil"));
