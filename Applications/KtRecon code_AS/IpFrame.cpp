...
//    AfxMessageBox(_T("Inside OnCopyData"));
    ...
    CKtDPSCommMgr::GetInstance()->SetParentName(bstrPageName);
    
    CKtReconView *pView = NULL;
    pView = (CKtReconView *)GetActiveView();
...
//        AfxMessageBox(_T("pView is NUll"));
    ...
    pView->PostMessage(WM_INIT_KTRECON,0,0); 
                                   ...
                                   UINT message)
{
    ...
    CKtReconView *pView = (CKtReconView *)GetActiveView();
