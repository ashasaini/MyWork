 ...
 *
 ******************************************************************************/
#ifndef __SM_PASCOM_SEQ_PARAM_H__
#define __SM_PASCOM_SEQ_PARAM_H__
...
#include "stdlib.h"
#include "PASCOMConstants.h"

#define	  WM_RECEIVE_SEQUENCE		WM_USER + 0x07


// Fore reference to classes
class CPASCOMSequence;
class CPAS;
class IPASCOMListener;
...
#endif  // #ifndef __SM_PASCOM_SEQ_PARAM_H__